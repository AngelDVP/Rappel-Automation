...
2. **Análisis Cognitivo**: Envía la imagen procesada a la API de OpenAI (GPT Vision) para realizar OCR inteligente y extraer descripciones comerciales complejas.
